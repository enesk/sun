...
return [
    ...
    'subscription' => [
        'title' => 'Abo-Details',
        'intro' => 'Laufzeit, Abbuchung und Kündigung deines Pakets.',
        'price' => 'Preis',
        'net' => 'netto zzgl. USt.',
        'term_ends' => 'Laufzeit endet',
        'active_until' => 'Aktiv bis',
        'provider' => 'Zahlungsart',
        'status_active' => 'Aktiv',
        'status_canceled' => 'Gekündigt',
        'to_plan' => 'Paket und Funktionen',
        'discard' => 'Kündigung zurücknehmen',
        'discard_done' => 'Kündigung zurückgenommen. Dein Abo verlängert sich wieder.',
        'discard_failed' => 'Die Kündigung lässt sich nicht mehr zurücknehmen.',
        'cancel_title' => 'Abo kündigen',
        'cancel_intro' => 'Die Laufzeit beträgt :laufzeit Monate, die Kündigungsfrist :frist Monate zum Ende der Laufzeit. Bis dahin bleiben alle Funktionen aktiv.',
        'cancel_unavailable' => 'Dieses Abo lässt sich hier nicht kündigen. Schreib uns, wenn du kündigen möchtest.',
        'cancel_submit' => 'Kündigung absenden',
        'cancel_running' => 'Wird gekündigt …',
        'cancel_abort' => 'Abbrechen',
        'reason' => 'Warum kündigst du?',
        'reason_placeholder' => 'Grund wählen',
        'reasons' => [
        ...
        'note' => 'Möchtest du uns noch etwas sagen?',
        'note_placeholder' => 'Das hilft uns, das Angebot zu verbessern.',
        'none_title' => 'Kein laufendes Abo',
        'none_text' => 'Für deinen Betrieb läuft derzeit kein Paket. Du nutzt den kostenlosen Basis-Eintrag.',
        'none_cta' => 'Pakete ansehen',
        'intervals' => [
            'day' => 'Tag',
            'week' => 'Woche',
            'month' => 'Monat',
