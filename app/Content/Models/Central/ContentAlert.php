...
class ContentAlert extends Model
{
     ...
     * ueber DisplayStatus, nicht ueber die Alarmstufe.
     */
    public function displayStatus(): string
    {
        return match ($this->level) {
            self::LEVEL_CRITICAL => DisplayStatus::FAILED->value,
            self::LEVEL_INFO => DisplayStatus::SCHEDULED->value,
            default => DisplayStatus::REVIEW->value,
        };
    }
