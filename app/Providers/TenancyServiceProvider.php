...
use Saasykit\FilamentTenancyForLaravel\Middleware\InitializeTenancyByDomain;
...
class TenancyServiceProvider extends ServiceProvider
{
    ...
    public const TENANCY_INITIALIZER = InitializeTenancyByDomain::class;
        ...
        return [
            ...
            Events\TenantCreated::class => [
                JobPipeline::make([
                    ...
                    // Tenant-Storage-Verzeichnisse anlegen + Symlink erstellen
            ...
            Events\TenancyBootstrapped::class => [
                \App\Listeners\Tenant\SetTenantStorageUrl::class,
            ],
    ...
    public function register()
    {
        ...
        DatabaseConfig::generatePasswordsUsing(function ($tenant) {
