...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /**
         * Quelldatenbank für den Import (sanitaer).
         * Wird von ImportSanitaerDataCommand verwendet.
         */
        'sanitaer_source' => [
            'driver' => 'mysql',
            'host' => env('IMPORT_DB_HOST', '127.0.0.1'),
            'port' => env('IMPORT_DB_PORT', '3306'),
            'database' => env('IMPORT_DB_DATABASE', 'sanitaer'),
        ...
        'makler' => [
            'driver' => 'mysql',
            'url' => env('MAKLER_DATABASE_URL'),
            'host' => env('MAKLER_DB_HOST', '127.0.0.1'),
            'port' => env('MAKLER_DB_PORT', '3306'),
            'database' => env('MAKLER_DB_DATABASE', 'tenant_makler'),
            'username' => env('MAKLER_DB_USERNAME'),
            'password' => env('MAKLER_DB_PASSWORD'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
