...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-xl sm:text-2xl font-bold text-base-content">Rollen</h1>
            <p class="text-sm text-base-content/60 mt-1">Berechtigungsrollen für Workspace-Mitglieder verwalten</p>
        </div>
        <a href="{{ route('verwaltung.roles.create') }}"
