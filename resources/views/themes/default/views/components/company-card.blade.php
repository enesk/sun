            ...
            <div class="flex-1 p-5 flex flex-col justify-between min-w-0">
                ...
                <div class="flex items-center justify-between gap-3 mt-auto pt-2 border-t border-[#F1F5F9]">
                    ...
                    <div class="flex items-center gap-1.5 shrink-0">
                        @if($company->tel)
                            <x-phone-link :number="$company->tel" :fallback="false" class="company-card__action" title="Anrufen" aria-label="{{ $company->name }} anrufen">
                        ...
                        @endif
                        <a href="{{ $company->portal_url }}" class="company-card__action company-card__action--primary" title="Details ansehen" aria-label="Details zu {{ $company->name }} ansehen">
    ...
    @else
        ...
        <div class="p-5">
            ...
            <div class="company-card__actions">
                @if($company->tel)
                    <x-phone-link :number="$company->tel" class="company-card__action-btn ripple" aria-label="{{ $company->name }} anrufen">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        Anrufen
                    </x-phone-link>
                @endif
                <a href="{{ $company->portal_url }}" class="company-card__action-btn company-card__action-btn--primary ripple">
                    Details
