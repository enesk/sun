<x-layouts.email>
    <x-slot name="preview">
        Neue Firma auf {{ $details['portal'] }}: {{ $details['company'] }}
    </x-slot>
    ...
    <tr>
        <td class="sm-px-6" style="border-radius: 4px; padding: 48px; font-size: 16px; color: #334155; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05)" bgcolor="#ffffff">
            ...
            <p style="margin: 0 0 16px; line-height: 24px">
                Auf {{ $details['portal'] }} wurde eine Firma über „Firma eintragen“ angelegt:
            </p>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 24px;">
                ...
                @if($details['address'])
                <tr>
                    <td style="padding: 8px 0; font-weight: 600; color: #64748b;">Adresse:</td>
                    <td style="padding: 8px 0;">{{ $details['address'] }}</td>
                </tr>
                @endif
                @if($details['tel'])
                <tr>
                    <td style="padding: 8px 0; font-weight: 600; color: #64748b;">Telefon:</td>
                ...
                @endif
                <tr>
                    <td style="padding: 8px 0; font-weight: 600; color: #64748b;">Eingetragen von:</td>
                ...
                <tr>
                    ...
                    <td style="padding: 8px 0;">{{ $details['created_at'] }} Uhr</td>
                </tr>
            </table>

            <p style="margin: 0 0 16px; line-height: 24px">
                <a href="{{ $details['edit_url'] }}" style="color: #1d4ed8; font-weight: 600;">Firma in der Verwaltung öffnen</a>
            </p>
